...
const SingleRepository = () => {
    const { id } = useParams();
    const { repository, isLoading, fetchMore } = useRepository({id, first: 3});
    ...
    <View>
        ...
        <FlatList
        data={reviews}
        renderItem={(review) => <ReviewItem review={review.item.node} key={review.item.node.id}/>}
